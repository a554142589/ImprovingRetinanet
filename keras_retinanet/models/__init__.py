...
class Backbone(object):
    ...
    def __init__(self, backbone):
        ...
        self.custom_objects = {
            ...
            'mask_focal_loss': losses.mask_focal(),
            'tensorflow': tensorflow,
            'joint_loss': losses.joint_mask_loss()
            # 'UpsampleLike'     : layers.UpsampleLike,
            # 'non_local_block'  :  non_local.non_local_block,
            # 'PriorProbability' : initializers.PriorProbability,
            # 'RegressBoxes'     : layers.RegressBoxes,
            # 'FilterDetections' : layers.FilterDetections,
            # 'Anchors'          : layers.Anchors,
            # 'ClipBoxes'        : layers.ClipBoxes,
            # 'smooth_l1_loss'       : losses.smooth_l1(),
            # '_smooth_l1': losses.smooth_l1(),
            # '_focal': losses.focal(),
...
def backbone(backbone_name):
    ...
    elif 'inception_v4' in backbone_name:
        from .inception_v4 import InceptionV4Backbone as b
