...
def __create_pyramid_features(C0, C1, C2, C3, C4, C5, model_config, feature_size=256):
    ...
    P5 = non_local_block(P5,out_channels=feature_size,height=16,width=16, compression=1,mode='gaussian')
    ...
    P4, _ = AttentionBlock(P4, P5_upsampled)
    # P4_y = non_local_block(P4,out_channels=feature_size,height=32,width=32, compression=1, mode='dot', add_residual=False)
    # P4_y, _ = AttentionBlock(P4_y, P5_upsampled)
    ...
    P3, _ = AttentionBlock(P3, P4_upsampled)
    # P3_y = non_local_block(P3, out_channels=feature_size, height=64, width=64, compression=1, mode='dot', add_residual=False)
    # P3_y, _ = AttentionBlock(P3_y, P4_upsampled)
    ...
    P2, attention_map = AttentionBlock(P2, P3_upsampled)
    ...
    P1, _ = AttentionBlock(P1, P2_upsampled)
    ...
    P0, _ = AttentionBlock(P0, P1_upsampled)
    ...
    P6 = non_local_block(P6, out_channels=feature_size, height=8,width=8, compression=1, mode='dot')
...
def retinanet(
    ...
    Returns
        ...
        ```
    """
    print("#### Using RetinaNet with non-local blocks only on (P5 P6) ####")
