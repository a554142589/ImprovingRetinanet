...
def _load_data_test():
    ...
    while True:
        yield np.zeros([512, 512, 3]).astype(np.float32), (np.zeros([327360, 5]).astype(np.float32), np.zeros([327360, 2]).astype(np.float32), np.zeros([512, 512, 2]).astype(np.float32))
        # yield np.zeros([512, 512, 3]).astype(np.float32), (np.zeros([327360, 5]).astype(np.float32), np.zeros([327360, 2]).astype(np.float32), np.zeros([512, 512, 2]).astype(np.float32))
