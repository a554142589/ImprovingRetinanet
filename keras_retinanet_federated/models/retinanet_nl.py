...
def AttentionBlock(x, g, name):
    ...
    psi = keras.layers.Conv2D(1, kernel_size=1,name=name+'_psiConv')(psi)
    psi = keras.layers.BatchNormalization(name=name+'_psiBN')(psi)
...
def __create_pyramid_features(C0, C1, C2, C3, C4, C5, model_config, feature_size=256):
    ...
    P2, attention_map = AttentionBlock(P2, P3_upsampled,name='P2Attn')
    ...
    P0, _ = AttentionBlock(P0, P1_upsampled,name='P0Attn')
...
def default_submodels(num_classes, num_anchors, model_config):
    ...
    """
    # return default_regression_model(4, num_anchors, model_config)
    return [
...
def __build_pyramid(models, features):
    ...
    """
    # return [__build_model_pyramid(n, m, features) for n, m in models][0]
