...
from keras_retinanet.models.resnet_forked import ResNet50, ResNet101, ResNet152
...
def resnet_retinanet(num_classes, backbone='resnet50', inputs=None, modifier=None, channels=None, **kwargs):
    ...
    layer_outputs = [inputs] + resnet.outputs
