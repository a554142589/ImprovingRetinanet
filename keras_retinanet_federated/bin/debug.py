...
def run(generator, args, anchor_params):
    ...
    for i in range(generator.size()):
        ...
        if args.random_transform:
            image, mask, annotations = generator.random_transform_group_entry(image, mask, annotations)
        ...
        anchors = anchors_for_shape(image.shape, anchor_params=anchor_params, pyramid_levels=[2, 3, 4, 5, 6])
