...
def main(args=None, model_config=None):
    ...
    # start training
    # train_generator = _load_data_test()
    ...
    #  generator=_load_data_test, output_types=(tf.float32,(tf.float32,tf.float32,tf.float32)), \
    #  output_shapes=(tf.TensorShape([512, 512, 3]), (tf.TensorShape([327360, 5]),tf.TensorShape([327360, 2]),tf.TensorShape([512, 512, 2]))))
    # # dataset = tf.data.Dataset.from_generator( 
    # #  generator=_load_data_test, output_types=(tf.float32,(tf.float32,tf.float32)), \
    # #  output_shapes=(tf.TensorShape([512, 512, 3]), (tf.TensorShape([327360, 5]),tf.TensorShape([327360, 2]))))
    ...
    #     return dataset.repeat(3).map(element_fn).shuffle(100).batch(2)
